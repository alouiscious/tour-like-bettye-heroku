...
# Seed_Loader :db do
#     desc "Prints @@seeder.all in a seeds.rb way."
#     task :seed => :environment do
#       @seeder.order(:id).all.each do |details|
#         bindind.pry
#         puts "Venue.create(#{details.serializable_hash.delete_if {|key, value| ['created_at','updated_at','id'].include?(key)}.to_s.gsub(/[{}]/,'')})"
#       end
#     end
#   end
# end